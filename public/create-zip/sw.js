...
const PRECACHE_URLS = [
  '/create-zip/',
  '/create-zip/manifest.json',
  '/create-zip/icon-192.png',
  '/create-zip/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/create-zip/manifest.json';
}
