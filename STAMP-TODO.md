# create-zip — stamped from heic-to-jpg, ENGINE + CONTENT still TODO

Frozen core and the slug surface are done. This tool currently builds as a HEIC clone
at /create-zip/. Replace the engine layer before it is real:
...
- [ ] `src/i18n/{en,ja,zh,de,es}.ts` — 5 native content sets via the competitor-grounded
      ...
      Also fix the PWA display name in `public/create-zip/manifest.json` ("HEIC to JPG").
