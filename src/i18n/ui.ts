...
export const ui = {
  en: {
    ...
    uploadSubtitle: 'Choose the files to put in the ZIP.',
    dropClick: 'Click to choose files',
    dropOr: 'or drop files anywhere on the page',
    dropSupported: 'Any file type',
    dropFolder: 'Select a folder',
    settingsButton: 'Settings',
    createZipButton: 'Create ZIP',
    creatingZip: 'Creating',
    removeFile: 'Remove',
    ...
    dzDropSub: 'Any files can be added to the archive',
  ...
  ja: {
    ...
    uploadSubtitle: 'ZIP にまとめるファイルを選んでください。',
    dropClick: 'クリックして選択',
    dropOr: 'またはページ上にドロップ',
    dropSupported: 'どんなファイルでも追加できます',
    dropFolder: 'フォルダを選択',
    settingsButton: '設定',
    createZipButton: 'ZIP を作成',
    creatingZip: '作成中',
    removeFile: '削除',
  ...
  zh: {
    // ConversionManager
    uploadHeading: '选择文件',
    uploadSubtitle: '选择要打包进 ZIP 的文件。',
    dropClick: '点击选择文件',
    dropOr: '或把文件拖到页面任意位置',
    dropSupported: '任意文件类型',
    dropFolder: '选择文件夹',
    settingsButton: '设置',
    createZipButton: '创建 ZIP',
    creatingZip: '正在创建',
    removeFile: '移除',
  ...
  de: {
    ...
    uploadSubtitle: 'Wähle die Dateien für das ZIP aus.',
    dropClick: 'Zum Auswählen klicken',
    dropOr: 'oder Dateien irgendwo auf die Seite ziehen',
    dropSupported: 'Jeder Dateityp',
    dropFolder: 'Ordner auswählen',
    settingsButton: 'Einstellungen',
    createZipButton: 'ZIP erstellen',
    creatingZip: 'Wird erstellt',
    ...
    errUnsupported:
      'Diese Datei konnte nicht hinzugefügt werden ({name}).',
    ...
    dzDropSub: 'Beliebige Dateien lassen sich hinzufügen',
  ...
  es: {
    ...
    uploadSubtitle: 'Elige los archivos para el ZIP.',
    dropClick: 'Haz clic para elegir archivos',
    dropOr: 'o suelta archivos en cualquier parte de la página',
    dropSupported: 'Cualquier tipo de archivo',
    dropFolder: 'Seleccionar carpeta',
    settingsButton: 'Configuración',
    createZipButton: 'Crear ZIP',
    creatingZip: 'Creando',
    removeFile: 'Quitar',
    ...
    errUnsupported: 'No se pudo añadir este archivo ({name}).',
    ...
    dzDropSub: 'Se puede añadir cualquier archivo',
